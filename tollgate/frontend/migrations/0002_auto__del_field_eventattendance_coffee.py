...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventAttendance.coffee'
        db.delete_column('frontend_eventattendance', 'coffee')

    def backwards(self, orm):
        # Adding field 'EventAttendance.coffee'
        db.add_column('frontend_eventattendance', 'coffee',
